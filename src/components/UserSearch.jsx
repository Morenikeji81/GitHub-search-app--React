    ...
    >
      <div className="hey w-[573px] md:w-[700px] mt-6 md:my-16">
        ...
        {userData ? (
            ...
            <div className='md:px-2'>
              ...
              <div className="mt-8 md:pl-4">
                ...
                <div className="flex flex-col md:flex-row md:justify-between md:pr-36 md:mt-5">
                  <span className={`flex gap-3 font-[14px] mb-3 ${theme === 'dark' ? 'text-white' : 'text-4B6A9B'}`}>
                    <img src="./chain.png" alt="" /> <a href={userData.html_url} className="hover:underline">
                      https://github.blog
                    </a>
                  </span>
                  <span className={`flex gap-3 font-[14px] mb-3 ${theme === 'dark' ? 'text-white' : 'text-4B6A9B'}`}>
          ...
          >
            <img src="./Bitmap.jpg" className="w-[117px] h-[117px] rounded-full md:block hidden" alt="avatar" />
            <div>
              <div className="flex justify-between items-center">
                <img src="./Bitmap.jpg" className="w-[117px] h-[117px] rounded-full md:hidden" alt="avatar" />
                <div className="ml-4">
              ...
              <div className="mt-8">
                ...
                <div className="flex flex-col md:flex-row md:gap-[70px] md:mt-5">
                  <span className={`flex gap-3 font-[14px] mb-3 ${theme === 'dark' ? 'text-white' : 'text-4B6A9B'}`}>
                    <img src="./chain.jpg" alt="" /> <a href="http://github.com">https://github.blog</a>
                  </span>
                  <span className={`flex gap-3 font-[14px] mb-3 ${theme === 'dark' ? 'text-white' : 'text-4B6A9B'}`}>
